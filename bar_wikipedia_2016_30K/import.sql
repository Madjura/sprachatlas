CREATE DATABASE `bar_wikipedia_2016_30K` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE bar_wikipedia_2016_30K;
...
CREATE TABLE `words` (
  ...
  KEY `word` (`word`),
  KEY `w_id` (`w_id`)
) ENGINE=MyISAM AUTO_INCREMENT=97896 DEFAULT CHARSET=utf8;
...
CREATE TABLE `sources` (
  ...
  KEY `so_id` (`so_id`),
  KEY `date` (`date`)
) ENGINE=MyISAM AUTO_INCREMENT=8683 DEFAULT CHARSET=utf8;
...
LOAD DATA LOCAL INFILE 'bar_wikipedia_2016_30K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'bar_wikipedia_2016_30K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'bar_wikipedia_2016_30K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'bar_wikipedia_2016_30K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'bar_wikipedia_2016_30K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'bar_wikipedia_2016_30K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'bar_wikipedia_2016_30K-sources.txt' INTO TABLE sources;
