"""
Django settings for sprachatlas project.
...
SECRET_KEY = 'r0gpcw$s5e(5##sl0)a-=h&!uor234_cnd3ca2k4nj^l@k5a$b'
...
WSGI_APPLICATION = 'sprachatlas.wsgi.application'
